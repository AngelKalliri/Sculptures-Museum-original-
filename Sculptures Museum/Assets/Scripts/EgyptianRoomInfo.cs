	...
	void Update () {
		if (Input.GetKeyDown ("e")) {
			...
			if (Physics.Raycast(ray, out hit)){
				...
				if (hit.transform.name == "PharaohInfo"){
				...
				if (hit.transform.name == "IsisInfo"){
				...
				if (hit.transform.name == "NefertitiInfo"){
				...
				if (hit.transform.name == "BearersInfo"){
				...
				if (hit.transform.name == "OsirisInfo"){
				...
				if (hit.transform.name == "RamessesIIInfo"){
				...
				if (hit.transform.name == "RamessesIIIInfo"){
				...
				if (hit.transform.name == "RedSarcoInfo"){
				...
				if (hit.transform.name == "ShawabtiInfo"){
				...
				if (hit.transform.name == "SobekInfo"){
				...
				if (hit.transform.name == "TaweretInfo"){
				...
				if (hit.transform.name == "CoffinInfo"){
