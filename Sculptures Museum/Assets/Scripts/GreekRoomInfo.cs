	...
	void Update () {
		if (Input.GetKeyDown ("e")) {
			...
			if (Physics.Raycast(ray, out hit)){
				...
				if (hit.transform.name == "JasonInfo"){
				...
				if (hit.transform.name == "PythagoreInfo"){
				...
				if (hit.transform.name == "DiscobolusInfo"){
				...
				if (hit.transform.name == "DemosthenesInfo"){
				...
				if (hit.transform.name == "AmazonInfo"){
				...
				if (hit.transform.name == "AthenaFarnInfo"){
				...
				if (hit.transform.name == "AthenaLemniaInfo"){
				...
				if (hit.transform.name == "VenusInfo"){
				...
				if (hit.transform.name == "AsclepiusInfo"){
				...
				if (hit.transform.name == "AriadneInfo"){
